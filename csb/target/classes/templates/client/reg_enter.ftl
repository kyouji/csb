		...
		<article class="reg">
			...
			<#if enterType_list??>
				<#list enterType_list as item>
					<input class="type_radio" type="radio" style="display:none;"  id="enterType${item_index}"  name="enterType" value="${item.title!''}" <#if item_index == 0> checked="checked" </#if>>
					<input class="type_radio" type="radio" style="display:none;"  id="enterTypeId${item_index}"  name="enterTypeId"  value="${item.id?c!''}" <#if item_index == 0> checked="checked" </#if>>
