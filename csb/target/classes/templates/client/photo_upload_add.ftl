	...
	<body style="background: #f2f2f2;">
			...
			<section class="poto" style="height:300px;">	
				<ul class="poto_box" style="display:table;text-align:center;max-height:300px;">
						<#if photo??><img src="/images/${photo.imgUrl!''}" width=100% height=100%/></#if>
				</ul>
			...
			<input class="get_sub" type="button" name="" id="billSubmit" onclick="location.href='/bill/upload/confirm?photoId='+<#if photo??>${photo.id?c}</#if>;" value="确定" />
	</body>
</html>
