...
<form name="form1" method="post" action="/Verwalter/bill/gather/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      ...
      <ul class="icon-list">
      	<li><a class="del" href="/Verwalter/bill/gather/import?time=${time!''}"><i></i><span>导入excel</span></a></li>
      </ul>
    	<div class="menu-list">
    ...
    <#if gather_page??>
        <#list gather_page.content as item>
            <tr>
                ...
                <td align="center"><#if item.statusId??><#if item.statusId==0>否<#elseif item.statusId==1>是</#if></#if></font></td>

                <td align="center">
                    <a href="/Verwalter/bill/gather/deal/${item.id}?time=${time!''}">详情</a>
                </td>    
              </tr>
        </#list>
    </#if>
