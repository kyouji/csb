        ...
        <dd>
            <div class="rule-multi-radio multi-radio">
                <span id="rblStatus" style="display: none;">
                    <input type="radio" name="statusId" value="1" <#if apply?? && apply.statusId?? && apply.statusId==1>checked="checked"</#if> ><label>已处理</label>
                    <input type="radio" name="statusId" value="2" <#if !apply?? || apply?? && apply.statusId?? && apply.statusId==0>checked="checked"</#if>><label>待处理</label>
                </span>
            </div>
        </dd>
    </dl>   
