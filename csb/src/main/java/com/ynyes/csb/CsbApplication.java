...
@Configuration
@ComponentScan(basePackages={"com.ynyes.csb"})
@EnableAutoConfiguration
public class CsbApplication extends SpringBootServletInitializer implements CommandLineRunner {
    @Autowired
